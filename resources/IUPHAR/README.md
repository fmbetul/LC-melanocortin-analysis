...
| `GtP_to_HGNC_mapping.csv` | IUPHAR target → HGNC symbol mapping (all receptor/ligand families) | `02_meta_integration.Rmd`, `03_basak_visium.Rmd`, `04_visium_integrated.Rmd` |

## How to Re-download

1. Navigate to https://www.guidetopharmacology.org/DATA/
